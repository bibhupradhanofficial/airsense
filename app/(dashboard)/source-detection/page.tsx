                ...
                <CardContent className="p-4 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-gray-500 leading-relaxed">
                            The AirSense ML model analyzes the CO/NO2 and PM2.5/PM10 secondary ratios across our sensor network. By correlating these shifts with high-resolution weather vectors, we can calculate the probability of specific source contributions in real-time.
                        </p>
                    </div>
                </CardContent>
            </Card>
