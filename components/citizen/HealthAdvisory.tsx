    ...
    return (
        <div className="space-y-4 text-left">
            <Alert
                ...
                style={{ backgroundColor: isBiomassBurning ? '#FEF3C7' : `${display.color}15`, borderLeft: `4px solid ${isBiomassBurning ? '#F59E0B' : display.color}` }}
            >
                <Icon className="h-5 w-5" style={{ color: isBiomassBurning ? '#F59E0B' : display.color }} />
                <AlertTitle className="font-bold ml-2" style={{ color: isBiomassBurning ? '#92400E' : display.color }}>
