...
export const AQIGauge: React.FC<AQIGaugeProps> = ({ aqi, loading = false }) => {
    ...
    if (loading) {
        return (
            <div className="relative flex flex-col items-center justify-center">
                <div className="h-64 w-64 animate-pulse rounded-full bg-zinc-100" />
                <div className="mt-4 h-8 w-32 animate-pulse rounded bg-zinc-100" />
            </div>
        );
    }
    ...
    return (
        <div className="relative flex flex-col items-center justify-center">
            ...
            <div
                className="mt-2 rounded-full px-6 py-1 text-lg font-semibold text-white shadow-sm"
