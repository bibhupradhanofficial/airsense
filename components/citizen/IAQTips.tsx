    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-black text-zinc-900 tracking-tight">Indoor Air Quality Strategy</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {TIPS.map((tip, i) => (
                    <Card key={i} className="p-6 border-zinc-100 shadow-sm hover:shadow-md transition-all flex gap-4 text-left">
                        <div className="h-12 w-12 shrink-0 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center">
                            {tip.icon}
                        </div>
